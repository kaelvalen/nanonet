...
const serviceItems = [
  { label: "auth-service", id: "auth-service", status: "up" },
  { label: "payment-service", id: "payment-svc", status: "up" },
  { label: "notification-service", id: "notification", status: "down" },
  { label: "user-management", id: "user-mgmt", status: "up" },
  { label: "analytics-engine", id: "analytics", status: "degraded" },
  { label: "email-service", id: "email-svc", status: "up" },
];
    ...
    <>
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            {/* Soft glow behind palette */}
            <div className="absolute -inset-4 bg-gradient-to-b from-[#39c5bb]/10 via-[#c4b5fd]/8 to-transparent rounded-3xl blur-2xl" />

            <div className="relative">
              {/* Decorative top shimmer */}
              <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-[#39c5bb]/30 to-transparent z-10 rounded-full" />
              ...
              <Command className="bg-white/95 backdrop-blur-xl border border-[#39c5bb]/15 rounded-2xl shadow-xl shadow-[#39c5bb]/5 overflow-hidden">
                ...
                <CommandList className="max-h-[400px] p-2">
                  ...
                  <CommandGroup heading={
                    <span className="text-[10px] tracking-widest text-[#39c5bb] uppercase">Navigation</span>
                  }>
                  ...
                  {/* Services */}
                  <CommandGroup heading={
                    <span className="text-[10px] tracking-widest text-[#93c5fd] uppercase">Services</span>
                  }>
                    {serviceItems.map((service) => (
                      ...
                      >
                        ...
                        <span className="flex-1 font-[var(--font-mono)] text-xs">{service.label}</span>
                        <span className={`text-[10px] font-[var(--font-mono)] px-1.5 py-0.5 rounded-full ${
                          service.status === "up" ? "bg-[#a7f3d0]/30 text-[#059669] border border-[#a7f3d0]/50" :
                          service.status === "degraded" ? "bg-[#fef3c7]/50 text-[#d97706] border border-[#fcd34d]/50" :
                  ...
                  {/* Actions */}
                  <CommandGroup heading={
                    <span className="text-[10px] tracking-widest text-[#c4b5fd] uppercase">Actions</span>
                  }>
