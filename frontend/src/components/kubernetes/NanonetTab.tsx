...
import { Loader2, RefreshCw, AlertTriangle, Package2, PackageCheck, PackageX, Plus, Minus } from "lucide-react";
import type { Service } from "@/types/service";
import { DeploymentInfo } from "@/api/k8s";
...
export interface NanonetTabProps {
    ...
    isAvailable: boolean;
    deployForms: Record<string, { image: string; replicas: number; open: boolean }>;
    setDeployForms: React.Dispatch<React.SetStateAction<Record<string, { image: string; replicas: number; open: boolean }>>>;
    deployMutation: any;
