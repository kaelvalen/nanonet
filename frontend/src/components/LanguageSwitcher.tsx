...
export function LanguageSwitcher() {
  ...
  return (
    <div className="flex items-center justify-between py-3 px-4 border-b border-border">
      ...
      <Select value={language} onValueChange={(value) => handleLanguageChange(value as 'en' | 'tr')}>
        <SelectTrigger id="language-select" className="w-32" aria-label={i18n.t('settings.language')}>
          <SelectValue />
        </SelectTrigger>
        <SelectContent>
