...
interface LoadBalancingTabProps {
  serviceId: string;
  serviceName: string;
              ...
              {deployment && (
                <Card className="p-5 rounded" style={{ background: "var(--surface-card)", border: "2px solid var(--color-lavender-border)", boxShadow: "var(--card-shadow)" }}>
                  ...
                  {hpaInfo && (
                    <div className="grid grid-cols-4 gap-2 mb-4">
                      {[
                        { label: "Min", value: hpaInfo.min_replicas, color: "var(--color-lavender)" },
                        { label: "Max", value: hpaInfo.max_replicas, color: "var(--color-lavender)" },
    ...
    <div className="space-y-6">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
        <div className="flex items-center gap-3 mb-4">
          ...
          <div className="flex items-center gap-2">
            <Button variant="outline" size="sm" onClick={() => setAgentWizardOpen(true)} className="rounded text-xs h-8" style={{ borderColor: "var(--color-blue-border)", color: "var(--color-blue)" }}>
